jQuery(document).ready(function($) {
    ...
    $('body').on('click', '.devportf-icon-list li', function(){
        var icon_class = $(this).find('i').attr('class');
        $(this).addClass('icon-active').siblings().removeClass('icon-active');
        $(this).parent('.devportf-icon-list').prev('.devportf-selected-icon').children('i').attr('class','').addClass(icon_class);
        $(this).parent('.devportf-icon-list').next('input').val(icon_class).trigger('change');
    });

    $('body').on('click', '.devportf-selected-icon', function(){
    ...
    //Scroll to section
    $('body').on('click', '#sub-accordion-panel-devportf_home_panel .control-subsection .accordion-section-title', function(event) {
...
function scrollToSection( section_id ){
    ...
    switch ( section_id ) {
        case 'accordion-section-devportf_slider_section':
        preview_section_id = "ht-home-slider-section";
        break;

        case 'accordion-section-devportf_about_section':
        preview_section_id = "ht-about-us-section";
        break;

        case 'accordion-section-devportf_featured_section':
        preview_section_id = "ht-featured-post-section";
        break;

        case 'accordion-section-devportf_portfolio_section':
        preview_section_id = "ht-portfolio-section";
        break;

        case 'accordion-section-devportf_service_section':
        preview_section_id = "ht-service-post-section";
        break;

        case 'accordion-section-devportf_team_section':
        preview_section_id = "ht-team-section";
        break;

        case 'accordion-section-devportf_testimonial_section':
        preview_section_id = "ht-testimonial-section";
        break;

        case 'accordion-section-devportf_counter_section':
        preview_section_id = "ht-counter-section";
        break;

        case 'accordion-section-devportf_blog_section':
        preview_section_id = "ht-blog-section";
        break;

        case 'accordion-section-devportf_client_logo_section':
        preview_section_id = "ht-logo-section";
        break;

        case 'accordion-section-devportf_cta_section':
